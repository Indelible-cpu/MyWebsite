    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            We are a youth-led technology innovation company based in Malawi, dedicated to driving digital transformation across Africa.
          </m.p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Indelible Technologies was founded on the belief that digital solutions shouldn't be out of reach for African institutions. We recognized a significant gap between the need for efficient management systems and the availability of affordable, localized solutions.
              </p>
              ...
              <div className="p-6 rounded-xl border-2 border-secondary/20 bg-secondary/5 mb-6">
                ...
                <p className="text-muted-foreground">
                  To become a trusted provider of innovative digital solutions that transform communities, institutions, and businesses through technology across Africa.
                </p>
              </div>
            </m.div>
            <m.div 
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-primary to-secondary/80 flex items-center justify-center p-8 text-center">
                <div className="text-primary-foreground">
                  ...
                  <p className="text-primary-foreground/80 text-lg">Empowering the next generation of African innovators.</p>
                </div>
              </div>
            </m.div>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Beyond building software, Indelible Technologies is deeply committed to the community. We actively invest in youth empowerment programs, digital literacy initiatives, and sustainable technology solutions that make a real difference in people's lives across Malawi.
          </p>
